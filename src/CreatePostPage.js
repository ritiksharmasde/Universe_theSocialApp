...
function CreatePostPage({ onBack, onSubmitPost, profileData }) {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const normalizedProfileImage = profileData?.profileImage?.startsWith(`${SERVER_BASE_URL}`)
                ? profileData.profileImage.replace(`${SERVER_BASE_URL}`, "")
                : profileData?.profileImage || "";

            postFormData.append("authorProfileImageUrl", normalizedProfileImage);
        ...
        <div style={styles.page}>
            <div style={styles.card}>
                ...
                <p style={styles.subtitle}>
                    Share Moments, doubt, note, or discussion with your university community.
                </p>
